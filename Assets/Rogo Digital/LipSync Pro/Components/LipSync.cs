							...
							else
							{
								...
								if (marker.blendToMarker)
								{
									...
									if (nextShape.HasBone(tempEmotionBones[index]))
									{
										...
										tempEmotionBoneCurves[index].AddKey(marker.endTime, Vector3.Lerp(b.neutralPosition, b.endPosition, nextMarker.intensity), Quaternion.Euler(Vector3.Lerp(b.neutralRotation, b.endRotation, nextMarker.intensity)), Vector3.Lerp(b.neutralScale, b.endScale, nextMarker.intensity), 0, 0);
									}
								}
							}
						}
